...
// Allows to type a new address in the text field & add the new address or cancel adding new address
...
const Checkout = () =>{
  ...
  // Fetching the  list of addresses for a user
  ...
  // Adding a new address and display the latest list of addresses
  ...
  //To delete an address and display the list of address
  ...
  // Fetch products and cart data on page load,otherwise push it into products page
  useEffect(() => {
